...
import {ACTIVE_EFFECT_MODES} from "../../../module/common/constants.mjs";

const ADD = ACTIVE_EFFECT_MODES.ADD
const MULTIPLY = ACTIVE_EFFECT_MODES.MULTIPLY
const UPGRADE = ACTIVE_EFFECT_MODES.UPGRADE
const DOWNGRADE = ACTIVE_EFFECT_MODES.DOWNGRADE
const OVERRIDE = ACTIVE_EFFECT_MODES.OVERRIDE
const CUSTOM = ACTIVE_EFFECT_MODES.CUSTOM
